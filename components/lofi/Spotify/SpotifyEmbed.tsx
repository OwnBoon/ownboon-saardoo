...
const SpotifyEmbed = (props: Props) => {
    ...
    return (
        <div >
            {sessionStarted && (
                <div
                    className={`${currentPage == '/lofi' && !hideElements ? "opacity-100" : "opacity-0"} transition-opacity ease-in-out delay-[2000] duration-300 absolute justify-center w-[300px] h-[400px] z-40 mr-[45vw] top-[100px] left-[100px] flex animate-slideup bg-gradient-to-br `}>
