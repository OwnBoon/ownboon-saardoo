...
const SpotifyEmbed = (props: Props) => {
    ...
    return (
        <div >
            {sessionStarted && (
                <div
                    className={`absolute justify-center w-[300px] h-[400px] z-40 mr-[45vw] bottom-11 right-0 flex animate-slideup bg-gradient-to-br ${currentPage == '/lofi' && !hideElements ? 'block' : 'hidden'}`}>
