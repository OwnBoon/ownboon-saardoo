...
const Discover = () => {
  ...
  const play =
    "opacity-100 transition-all duration-2000 btn ease-in-out mr-4 -mt-3";

  return (
    <Draggable>
    <div className="w-fit h-[80vh] -mt-1 md:left-32 md:top-28 md:absolute flex flex-col overflow-x-hidden">
      <Collapse.Group>
        <Collapse title="" expanded className="bg-white cursor-pointer btn hover:bg-opacity-20 transition-all duration-100 active:scale-105 bg-opacity-30 p-4 rounded backdrop-blur-lg">
            ...
            <div className="flex left-20 md:h-1/2  sm:justify-start w-fit bg-white bg-opacity-30  rounded-[5px] border border-white border-opacity-50 backdrop-blur-[30px]  overflow-x-hidden justify-center gap-8 ">
              <div className="flex h-fit w-fit scrollbar-none scrollbar flex-col items-start overflow-x-hidden">
                <div className="px-4 py-3 cursor-pointer ">
                  <div className="flex flex-row gap-[10vw] justify-around">
                    <h1 className="text-white font-sans text-base font-semibold">
                      Currently Playing
                    </h1>
                    {/* <button
                  className="bg-white cursor-pointer btn hover:bg-opacity-20 transition-all duration-100 active:scale-105 bg-opacity-30 p-4 rounded backdrop-blur-lg   flex items-center justify-center h-[2.3rem] w-[2.3rem]"
                  onClick={(e) => {
                    setVisible(!visible);
                  }}
                >
                  <div className="w-full bg-white select-none h-[2px]" />
                </button> */}
                  </div>
