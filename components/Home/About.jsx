      ...
      <div className="p-5 py-[8vh]   text-[#2E2E2E]   flex-wrap flex flex-row  font-poppins align-center items-center  justify-center  ">
        <div className="flex flex-col  md:w-[60vw] heading py-10 text-center md:text-left align-center justify-center mr-0 md:mr-5">
          ...
          <p className="text-[1rem] text-justify mt-3 md:text-[1.2vw] break-words ">
            ...
            truly supports personal growth and productivity at the same time, we
            set out to create a transformative space. Powered by AI tools and
            personalized roadmaps, OwnBoon provides a distraction-free
            environment for work, connection, and learning. Together, We've
            decided to shape a future where personal development and social
            connection thrive. Join us on this remarkable journey towards
            fulfillment and success. Together, We empower individuals to unlock
          ...
          <div className="flex mt-2 flex-row">
            <div className="flex px-3 flex-col">
              ...
              <div className="flex  justify-center items-center align-center flex-col">
                ...
                <h3 className="mt-1 text-center text-[14px]">CTO</h3>
              </div>
            </div>
            <div className="flex px-3  flex-col">
