...
export default function Notification({
  ...
  return (
    <div
      className={`flex flex-col fade fixed right-3 rounded-b-2xl w-[300px] max-h-[90vh] transition-all duration-[2000] overflow-scroll ${shownotifications ? "translate-y-0 top-24" : "-translate-y-[100vh] "
