...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`${
          show ? "navbarhide" : "navbarshow"
        } px-5 sm:px-4 text-[0.9rem] py-2.5 fixed  w-full z-100 bg-white z-20 top-0 left-0 text-[#2E2E2E]  font-inter `}
      >
        <div className="container bg-white flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="flex justify-center items-center  md:order-2">
            <Link
              href={"/sign-in"}
              className="  text-white flex justify-center items-center !bg-gradient-to-br !from-[#AA77FF] !via-[#00AEFF] !to-[#00F0B5]  sm:text-[1rem] xs:text[0.5rem] login  w-[111px] h-[38px] text-center  rounded-full"
            >
              Login
            </Link>
          </div>
