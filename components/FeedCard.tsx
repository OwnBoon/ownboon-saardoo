...
const FeedCard = ({ feeds }: Props) => {
  ...
  return (
    <div className="grid bg-black shadow-lg text-white h-full rounded-lg gap-2 p-0 lg:p-8 pb-12 mb-8 grid-cols-6">
  ...
  <div className="col-span-2 border-l px-2">
    ...
    <div className="space-y-4 mt-5 overflow-y-scroll h-72 shadow-lg rounded-lg p-2">
      {comments.map((comment) => (
        <Grid className="flex items-center text-white">
          <User name={comment.username} src={comment.profileImg} size={"sm"} />
